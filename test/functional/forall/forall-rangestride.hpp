...
protected:
  virtual void SetUp()
  {
    ...
    allocator_impl<util::val(get_platform<Policy>::value)> allocator;
...
TYPED_TEST_P(ForallRangeStrideFunctionalTest, Forall)
{
...
TYPED_TEST_P(ForallRangeStrideFunctionalTest, ForallIcount)
{
...
REGISTER_TYPED_TEST_CASE_P(ForallRangeStrideFunctionalTest, 
    Forall, ForallIcount, ForallView, ForallIcountView);
