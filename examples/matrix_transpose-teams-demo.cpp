...
int main(int argc, char *argv[])
{
  ...
  //
  // The following example is for a live demo using RAJA Teams
  //
  ...
  //CUDA thread blocks and threads are mapped directly to RAJA teams and threads
  RAJA::expt::Teams TeamSz(outer_Dimc, outer_Dimr);
  RAJA::expt::Threads ThreadSz(TILE_DIM,TILE_DIM);
 
  RAJA::expt::launch<launch_policy>
  (select_cpu_or_gpu, RAJA::expt::Resources(TeamSz, ThreadSz),
